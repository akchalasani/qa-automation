...
## TC-1,2,3,6
  Scenario: Verify the merchant landing page functionality
    ...
    ## TC-4,5,7,8
  Scenario: Verify the details and shop at links under cause section in merchant landing page
      Given I visit the good search home page
      When I search for site merchant link under search bar and clcik on it
      And I update the star ratings by clicking on it and login through emailid or facebook
      Then I verify shop button and details link functionality uner merchant landing page
